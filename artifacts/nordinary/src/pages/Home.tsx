  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="max-w-6xl mx-auto mt-12 pt-8 flex items-center justify-between"
          ...
          <div className="flex items-center gap-6">
            {["Impressum", "Datenschutz", "AGB"].map((l) => (
              <a
                ...
                href="#"
                className="text-xs"
                style={{ color: "rgba(255,228,188,0.25)", textDecoration: "none" }}
