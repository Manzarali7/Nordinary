...
const INITIAL_CHIPS = [
  {
    ...
    description: "Videos, die viral gehen",
    icon: ShieldCheck,
  },
  {
    id: 2,
    title: "Social-Media-Ads",
    description: "Maximale Performance & ROI",
    icon: Zap,
  },
  {
    id: 3,
    title: "Community-Management",
    description: "Echte Verbindungen schaffen",
    icon: Users,
  },
  {
    id: 4,
    title: "Branding & Design",
    description: "Einzigartiger Markenauftritt",
    icon: Sparkles,
  },
];
              ...
              {items.map((chip, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-[#0a0700]/80 border border-[rgba(255,233,71,0.2)] z-10 rounded-full p-2 w-[240px] shadow-[0_4px_24px_rgba(255,233,71,0.15)] absolute pointer-events-auto flex items-center gap-3 origin-bottom backdrop-blur-md"
                  >
                    <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-[#FFE947]/10 text-[#FFE947]">
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <span className="text-xs text-[#FFE947]/70 ">
                        {chip.description}
                      </span>
                    </div>
                  </motion.div>
        ...
        >
          ...
          <g filter="url(#filter0_i_51_65)">
            <path
              ...
              className="fill-[rgba(10,7,0,0.4)]"
            />
          </g>
            ...
            <foreignObject x="0" y="0" width="655" height="352">
              <div
                style={{
                  ...
                  height: "100%",
                  width: "100%",
                  background: "rgba(255,233,71, 0.05)",
                  clipPath:
